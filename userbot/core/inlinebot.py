...
CATLOGO = "https://telegra.ph/file/e297c482379f20bcc4017.jpg"
...
async def inline_handler(event):  # sourcery no-metrics
    ...
    if query_user_id == Config.OWNER_ID or query_user_id in Config.SUDO_USERS:
        ...
        if query.startswith("** "):
            ...
            result = builder.article(
                title="© Userbot Help",
                description="Help menu for Userbot",
                text=_result[0],
                buttons=_result[1],
                link_preview=False,
            )
        ...
        buttons = [
            (
                Button.url("Source code", "https://github.com/secretsofsuccess360/tguserbot"),
                Button.url(
                    "Deploy",
                    "https://github.com/secretsofsuccess360/tguserbot",
                ),
            )
        ]
        markup = event.client.build_reply_markup(buttons)
        ...
        result = types.InputBotInlineResult(
            ...
            url="https://github.com/secretsofsuccess360/tguserbot",
            thumb=photo,
            content=photo,
            send_message=types.InputBotInlineMessageMediaAuto(
                reply_markup=markup, message=text, entities=msg_entities
