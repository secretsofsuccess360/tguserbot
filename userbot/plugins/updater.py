...
async def upstream(event):
    ...
    off_repo = "https://github.com/secretsofsuccess360/catpack"
    os.chdir("/app")
...
@catub.cat_cmd(
    ...
    info={
        "header": "To update to goodcat.",
        "usage": "{tr}goodcat",
    },
)
async def variable(var):
    "To update to goodcat."
    ...
    heroku_var["UPSTREAM_REPO"] = "https://github.com/secretsofsuccess360/tguserbot"
